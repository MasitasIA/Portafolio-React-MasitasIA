        ...
        <header className="fixed top-4 inset-x-0 z-50 px-4 md:px-8">
            <div className="max-w-5xl mx-auto flex justify-between items-center w-full bg-zinc-950/60 backdrop-blur-xl border border-zinc-800/50 rounded-2xl px-6 py-3 shadow-2xl">
                <div className="flex items-center gap-4">
                    <Link
                        to="/"
                        className="text-2xl font-boldpixels text-zinc-100 tracking-tighter"
                    >
                ...
                <nav className="hidden md:flex items-center gap-1 bg-zinc-900/50 border border-zinc-800 rounded-full px-2 py-1">
                    <a
                        href="/#inicio"
                        className="px-4 py-1.5 text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-full transition-all duration-200"
                    >
                        {t.nav.inicio}
                    </a>
                    <a
                    ...
                    <Link
                        to="/proyectos"
                        className="px-4 py-1.5 text-sm font-medium text-indigo-300 bg-indigo-500/10 border border-indigo-500/30 hover:bg-indigo-500/20 hover:text-indigo-200 rounded-full transition-all duration-200"
                    >
                        {t.nav.proyectos}
                    </Link>
                ...
                <button
                    className="md:hidden p-2 text-zinc-300 hover:bg-zinc-800 rounded-xl transition-colors"
            ...
            {isMenuOpen && (
                <nav className="md:hidden mt-2 mx-auto max-w-sm bg-zinc-950/90 backdrop-blur-lg border border-zinc-800 rounded-2xl flex flex-col p-4 gap-2 shadow-2xl transition-all">
                    <a
                        href="/#inicio"
                        onClick={closeMenu}
                        className="px-4 py-3 rounded-xl text-zinc-300 hover:bg-zinc-900"
                    >
                        {t.nav.inicio}
                    </a>
                    <a
                    ...
                    <Link
                        to="/proyectos"
                        onClick={closeMenu}
                        className="px-4 py-3 rounded-xl font-medium text-indigo-300 bg-indigo-500/10 border border-indigo-500/30 hover:bg-indigo-500/20 transition-all duration-200"
                    >
                        {t.nav.proyectos}
                    </Link>
